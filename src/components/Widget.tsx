import { Rocket, X, Check, Heart, Pizza, Gamepad2} from 'lucide-react'
  ...
  return (
    <div className="w-[448px] rounded overflow-hidden">
      ...
      <div>
        ...
        <div className="divide-y-2 divide-zinc-300 dark:divide-zinc-950">
          <div className="bg-zinc-200 dark:bg-zinc-900 px-8 py-4 flex items-start gap-6">
            <Gamepad2 className="w-6 h-6 text-violet-500 mt-3" />
            <div className="flex-1 flex flex-col gap-2">
              <p className="text-sm leading-relaxed text-zinc-600 dark:text-zinc-100">
              Você recebeu um convite de <span className="font-bold">Juan Carlos</span> para jogar Rocket League.
                </p>
          ...
          <div className="bg-zinc-200 dark:bg-zinc-900 px-8 py-4 flex items-start gap-6">
            ...
            <div className="flex-1 flex flex-col gap-2">
              <p className="text-sm leading-relaxed text-zinc-600 dark:text-zinc-100">
                Um novo vídeo de <span className="font-bold">Marcos Vinicius</span> foi publicado no Linkedin! Vem conferir!
                </p>
              <div className="text-xxs text-zinc-400 flex items-center gap-1">
      ...
      <div>
        ...
        <div className="divide-y-2 divide-zinc-300 dark:divide-zinc-950">
          <div className="bg-zinc-200 dark:bg-zinc-900 px-8 py-4 flex items-start gap-6">
            <Pizza className="w-6 h-6 text-violet-500 mt-3" />
            <div className="flex-1 flex flex-col gap-2">
              <p className="text-sm leading-relaxed text-zinc-600 dark:text-zinc-100">
                Seu lanche foi entregue ao seu destino com sucesso!
                </p>
              <div className="text-xxs text-zinc-400 flex items-center gap-1">
          ...
          <div className="bg-zinc-200 dark:bg-zinc-900 px-8 py-4 flex items-start gap-6">
            ...
            <div className="flex-1 flex flex-col gap-2">
              <p className="text-sm leading-relaxed text-zinc-600 dark:text-zinc-100">
                <span className="font-bold">José Ribamar e mais 5 pessoas</span> gostaram do seu comentário.
                </p>
              <div className="text-xxs text-zinc-400 flex items-center gap-1">
                <span>Feed</span>
                <span>Há 3 min</span>
